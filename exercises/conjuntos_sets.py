...
conjunto_interseccion = conjunto_03 & conjunto_04 #el & encuentra los elementos comunes a ambos conjuntos. 
...
conjunto_interseccion = conjunto_03.intersection(conjunto_04) #otra forma de encontrar intersección es con el .intersection
...
conjunto_union = conjunto_05 | conjunto_06 #el | une los elementos de dos conjuntos en un nuevo
...
conjunto_union=conjunto_05.union(conjunto_06) #tmb pueden unirse con el .union
...
conjunto_diferencia = conjunto_07-conjunto_08 #con el - calculo la diferencia entre dos conjuntos.
...
conjunto_diferencia=conjunto_07.difference(conjunto_08) #tmb calculo diferencia con .difference
...
conjunto_diferencia_simetrica = conjunto_09 ^ conjunto_10 #puedo calcular la dif simetrica (aquellos elementos exclusivos de c/conjunto con ^)
...
conjunto_diferencia_simetrica=conjunto_09.symmetric_difference(conjunto_10) #tmb puedo calcularlo con .symmetric_difference

...
#en el format debo poner entre "" la cantidad de {} que haya, que va a ser igual a la cantidad de variables que ponga entre ()
assert (
...
#en el fstring es f"" y entre las comillas las variables entre {}
